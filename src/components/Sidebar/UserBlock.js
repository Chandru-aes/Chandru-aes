					 ...
					 >
						 ...
						 >
							 <div className="user-profile">
								 <img 
									 src={require('Assets/avatars/user-6.jpg')}
									 alt="user profile"
									 className=""
									 width=""
									 height=""
							 ...
							 <div className="user-info">
								 {/* <span className="user-name ml-4">Venkat</span>
								 <i className="zmdi zmdi-chevron-down dropdown-icon mx-4"></i> */}
							 </div>							
						 </DropdownToggle>
						 <DropdownMenu>
							 <ul className="list-unstyled mb-0">
								 <li className="p-15 border-bottom user-profile-top primary-bg-new rounded-top">
									 <p className="text-white mb-0 fs-14">Venkat</p>
									 <span className="text-white fs-14">venkat@ambattur.com</span>
								 </li>
								 <li>
									 <Link to={{
								 ...
								 <li>
									 <Link to={{
										 pathname: '/app/pages/change-password',
										 state: { activeTab: 2 }
									 }}>
										 <i className="zmdi zmdi-key text-success mr-3"></i>
