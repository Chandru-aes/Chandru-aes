...
const AsyncSessionForgotPasswordComponent1 = Loadable({
	loader: () => import("Routes/session/change-password"),
	loading: () => <RctPageLoader />,
});

const AsyncChangePasswordComponent = Loadable({
	loader: () => import("Routes/pages/changepassword"),
	loading: () => <RctPageLoader />,
});
// Session Page 404
...
// forms Tabs
const AsyncTabFormsComponent = Loadable({
	loader: () => import("Routes/forms/tab-forms"),
	loading: () => <RctPageLoader />,
});

// Stepper Forms
const AsyncStepperFormsComponent = Loadable({
	loader: () => import("Routes/forms/stepper-forms"),
	loading: () => <RctPageLoader />,
});
...
// components Grid List
const AsyncCarouselComponent = Loadable({
...
const AsyncAdvancedFormComponent = Loadable({
	loader: () => import("Routes/advanced-forms"),
	loading: () => <RctPageLoader />,
});

const CustomizedFormElement = Loadable({
...
const AsyncStyleEditComponent = Loadable({
	loader: () => import("Routes/pre-production/styling/style-edit"),
	loading: () => <RctPageLoader />,
});
...
const AsyncProductionRequestComponent = Loadable({
...
export {
	...
	AsyncSessionForgotPasswordComponent1,
