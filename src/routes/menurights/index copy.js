										 ...
										 return (
                                            <tr>
                                                ...
                                                <td align="center" className="radio-effects">
                                                    <input type="radio"  name="site_name" checked={n.menuRights=="F"}/>
                                                </td>
                                                <td align="center" className="radio-effects">
                                                    <input type="radio"  name="site_name" checked={n.menuRights=='R'}/>
                                                </td>
                                                <td align="center" className="radio-effects">
                                                    <input type="radio"  name="site_name" checked={n.menuRights=='N'}/>
                                                </td>
                                                <td>
                                                    <div className="form-group">                                            
