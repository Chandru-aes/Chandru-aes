                      ...
                      <div className="row row-eq-height">
                         ...
                         <div className="login-div">
                           ...
                           <div className="session-cont">
                                  <img src={require('Assets/img/acpl-logo-white.png')} alt="acpl-logo" className="img-fluid" /> 
                            ...
                            <div className="row">
                                 ...
                                 <img src={require('Assets/img/login-person-img.jpg')} alt="login-image" className="img-fluid" /> 
                                 </div>                                         
                             </div>                          
                             </div>
                               <Form>
