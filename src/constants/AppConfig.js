 ...
 */
 const AppConfig = {
   ...
   brandName: 'Ambattur Fashion India Private Limited ( AFIPL)',                                    // Brand Name
   ...
   copyRightText: '2021 Ambattur Fashion India Private Limited (AFIPL). All Rights Reserved.',      // Copy Right Text
   // light theme colors
   themeColors: {
      // 'primary': '#5D92F4',
      // 'secondary': '#677080',
